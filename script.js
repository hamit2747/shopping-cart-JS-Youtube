...
class Products {
    async getProducts() {
        try {
            let result = await fetch("https://64e73e7eb0fd9648b78f9bba.mockapi.io/products");
...
document.addEventListener("DOMContentLoaded", () => {
    ...
    products.getProducts().then(products => {
        ...
        ui.getBagButtons(); // Düğme dinleyicilerini eklemek için buraya taşıdık
        ui.cartLogic();     // Sepet mantığını uygulamak için buraya taşıdık
    });
